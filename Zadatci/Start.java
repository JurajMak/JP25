...
public class Start {
	...
	private void izbornik() {
		...
		/*
		 * switch (Unos.unesiInt(ulaz, "Odaberite akciju")) { case 1: unos(); break;
		 * case 2: promjena(); break; case 3: brisanje(); break; case 4: pregled();
		 * izbornik(); break; case 5:
		 * System.out.println("\nHvala Što ste koristili naš program, doviđenja!");
		 * break; default: System.out.println("Nije dobra opcija izbornika");
		 * izbornik(); }
		 */
